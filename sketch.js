...
var obstacle1,obstacle2,obstacle3,obstacle4,obstacle5,obstacle6,obstaclesGroup,obstacle;
var count = 0;
...
function draw() {
  background(220);
  text("Score:"+ Math.round(count),50,50);
  if(keyDown("space")) {
    trex.velocityY = -10;
  }
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    switch(rand){
      ...
      break;
      default:obstacle.addImage("obstacle6",obstacle6);
      break;
    }
